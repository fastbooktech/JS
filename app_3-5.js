// 최대한 제목화면클릭시 내용화면전환으로 느끼게끔
// appendchild를 안써보자! innerHTML로 없애ㅏㅈ!
...
// 3. 라우터를 통해 제목화면->내용화면 전환후 다시 제목호마ㅕㄴ으로 돌아오는 기능 추가. 여러 웹페이지 화면전환 어플리케이션 가능케하는 a,b,c 중 조건에 따라 특정 화면 비춰주는 화면 중계기같은게 라우터.
